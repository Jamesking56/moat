...
pub const HOW_TO_FIX: &str = "In all the links below > *Click* -> Start setup > *Edit* -> SECURITY.md (use a private disclosure channel: email or GitHub advisories) > *Click* -> Commit changes";
