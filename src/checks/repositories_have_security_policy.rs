...
pub const HOW_TO_FIX: &str = "In all the links below > __Click__ -> Start setup > __Edit__ -> SECURITY.md (use a private disclosure channel: email or GitHub advisories) > __Click__ -> Commit changes";
