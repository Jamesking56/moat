...
pub const HOW_TO_FIX: &str = "github → repository → settings → rules → \"New ruleset\" → \"New branch ruleset\" → target your release branches (main, master, x.x) and set enforcement status to \"Active\".";
